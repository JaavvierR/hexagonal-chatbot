...
const CREDENTIALS_FILE = path.join(__dirname, '..', '..', "fb_credentials.json"); // Ajustar ruta
...
export class LocalConfigService {
    async getChatData() {
        ...
        try {
            ...
            const response = await axios.get('http://localhost:5001/api/chat', { timeout: 3000 }); // Reducir timeout
