...
import { IUIService } from '../core/interfaces.js';
...
export class SeleniumUiService implements IUIService {
    ...
    async sendImage(imageUrl: string, imageName: string): Promise<boolean> {
        ...
        try {
            ...
            (imgResponse.data as NodeJS.ReadableStream).pipe(writer);
            ...
            try {
                ...
                if (!textBox) throw new Error("Text box not found for Ctrl+G");
